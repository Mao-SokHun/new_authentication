...
import CompleteTeacherProfile from './pages/onboarding/CompleteTeacherProfile'
...
const AppRoutes = () => (
  <Routes>
    ...
    <Route path="/onboarding/complete-teacher-profile" element={<CompleteTeacherProfile />} />
