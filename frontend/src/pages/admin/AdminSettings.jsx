    ...
    <PageScaffold title="Settings" subtitle="Manage your admin account and platform settings">
      ...
      {activeTab === 'appearance' && (
        <PageCard className="max-w-lg">
          ...
          <div className="mb-6">
            <label className="block text-xs font-bold text-slate-700 mb-3 uppercase tracking-wide">Accent Color</label>
          ...
          <div className="mb-6">
            <label className="block text-xs font-bold text-slate-700 mb-3 uppercase tracking-wide">Theme Mode</label>
