...
const initialComments = {
  1: [{ id: 'c1', author: 'Dr. Sarah Jenkins', time: '5m ago', content: 'Clean proof — well structured!' }],
  2: [{ id: 'c2', author: 'Sokha Dara', time: '30m ago', content: 'Strang lectures are the best.' }],
  3: [],
  4: [{ id: 'c3', author: 'Bopha Keo', time: '2h ago', content: 'Still working on this one!' }],
}
