...
const kpis = [
  { label: 'Total Students', value: '4,034', change: '+12.3%', icon: Users, tone: 'primary' },
  { label: 'Active Teachers', value: '88', change: '+8%', icon: BookOpen, tone: 'success' },
  { label: 'Monthly Revenue', value: '$90.9K', change: '+18.5%', icon: DollarSign, tone: 'primary' },
  { label: 'Session Rate', value: '75.4%', change: '+2.1%', icon: TrendingUp, tone: 'warning' },
]
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        <PageCard className="lg:col-span-2" padding>
          <div className="flex items-center justify-between mb-5 flex-wrap gap-3">
            <h2 className="font-bold text-slate-800">Platform Growth</h2>
            <TabBar
              tabs={[
        ...
        <PageCard padding>
          <h2 className="font-bold text-slate-800 mb-5">Learner Subject Focus</h2>
          <ResponsiveContainer width="100%" height={220}>
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        <PageCard padding={false} className="overflow-hidden">
          <div className="flex items-center justify-between p-5 border-b border-slate-100">
            ...
            <button type="button" className="text-xs text-primary-600 font-medium hover:underline">View all</button>
          </div>
        ...
        <div className="space-y-4">
          <PageCard>
            <h3 className="font-bold text-slate-800 mb-4 text-sm">Platform Stats</h3>
            <div className="grid grid-cols-2 gap-3">
              {[
                { label: 'Total Sessions', value: '1,291', sub: '+452 this month' },
                { label: 'Communities', value: '42', sub: '3 created today' },
                { label: 'Avg Rating', value: '4.8★', sub: 'across all teachers' },
                { label: 'Completion Rate', value: '87%', sub: '+4% vs last month' },
              ].map((s) => (
          ...
          <PageCard variant="brand" className="text-white" padding>
            <h3 className="font-bold mb-1">Pending Actions</h3>
            <p className="text-primary-100 text-xs mb-4">Items that need your attention</p>
            <div className="space-y-2.5">
              {[
                { label: 'Teacher applications', count: 3 },
                { label: 'Disputes to resolve', count: 2 },
                { label: 'Content to review', count: 8 },
              ].map((p) => (
